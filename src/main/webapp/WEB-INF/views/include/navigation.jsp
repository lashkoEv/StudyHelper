...
<head>
    ...
    <title>${title}</title>
    <link rel="icon" type="image/x-icon" href="<spring:url value="img/icon.ico"/>" />
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top navbar-bg" id="mainNav">
    <div class="container">
        <a class="navbar-brand" href="<spring:url value="/"/>"><i class="material-icons">school</i> Study helper</a>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="<spring:url value="/"/>">Усі матеріали</a>
                        <sec:authorize access="hasAnyRole('ROLE_EXPERT', 'ROLE_ADMIN')">
                            <a class="dropdown-item" href="<spring:url value="/posts/create"/>">Додати новий матеріал</a>
                        </sec:authorize>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="<spring:url value="/categories"/>">Усі категорії</a>
                        <sec:authorize access="hasAnyRole('ROLE_ADMIN')">
                            <a class="dropdown-item" href="<spring:url value="/categories/create"/>">Додати нову категорію</a>
                        </sec:authorize>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="<spring:url value="/experts"/>">Усі експерти</a>
